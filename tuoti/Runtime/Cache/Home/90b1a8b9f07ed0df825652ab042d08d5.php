<?php if (!defined('THINK_PATH')) exit();?><form action="<?php echo U('Login/leader_fen');?>" method="post">
    ...
    <table border="1">
        <tr>
            ...
            <td>
                <select name="t_id">
                    <?php if(is_array($ar)): $i = 0; $__LIST__ = $ar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["t_id"]); ?>"><?php echo ($v["t_teacher"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </td>
        </tr>
        <tr>
