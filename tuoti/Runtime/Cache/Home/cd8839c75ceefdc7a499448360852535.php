<?php if (!defined('THINK_PATH')) exit();?><form action="<?php echo U('Index/add_class');?>" method="post">
<table border="1">
...
<h3 style="color: deepskyblue;"><a href="<?php echo U('Index/show_class');?>">查看课程信息</a></h3>